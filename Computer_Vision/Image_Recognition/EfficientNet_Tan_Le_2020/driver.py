...
Created on Thu Oct 14 14:21:42 2021
...
if __name__ == '__main__':
    ...
    print(f"Number of parameters for EfficientNet-{version}: {total_params:,}")

    x_out = model(x)
    assert x_out.shape == torch.Size([num_examples, num_classes])
